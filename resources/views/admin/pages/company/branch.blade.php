...
<body>
    ...
    <style>
        .success_alert, .error_alert, .alert-box {
            position: fixed;
            top: -100px;
            left: 50%;
        ...
        .success_alert.hide, .error_alert.hide, .alert-box.hide {
    ...
    <div class="modal-content1">
        ...
        <form action="{{ route('branch.store') }}" method="POST" class="modal-body1">
            ...
            <div class="form-group">
                ...
                <input type="text" id="contact_person" name="contact_person" required placeholder="Enter a Contact Person">
            </div>
            <div class="form-group">
                <label for="phone">Phone Number</label>
                <input type="text" id="phone" name="phone" required placeholder="Enter Contact Person's Phone Number">
            </div>
            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" id="email" name="email" required placeholder="Enter Contact Person's Email">
            </div>
                ...
                <table class="custom-table" id="table">
                    ...
                    <tbody>
                        ...
                        <tr data-status="{{ $branch->status }}">
                            ...
                            <td> 
                                <div class="action-buttons">    
                                    @if ($branch->status == 'open')
                                        <a href="#" class="status-button-open-button" onclick="toggleBranchStatus('{{ $branch->id }}', 'close')">
                                            <i class="fas fa-check-circle"></i><span>Open</span>
                                        </a>
                                    @else
                                        <a href="#" class="status-button-close-button" onclick="toggleBranchStatus('{{ $branch->id }}', 'open')">
                            ...
                            <td class="actions">
                                <a href="javascript:void(0);" class="edit-btn tooltip" data-id="{{ $branch->id }}" 
                                    data-province="{{ $branch->province }}" data-address="{{ $branch->address }}" 
                                    data-contact_person="{{ $branch->contact_person }}" data-phone="{{ $branch->phone }}" 
...
<script>
    ...
    editBtns.forEach(btn => {
        btn.addEventListener("click", function () {
            ...
            document.getElementById("edit-contact_person").value = this.getAttribute("data-contact_person");
